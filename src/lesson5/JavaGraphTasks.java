        ...
        for (Graph.Vertex vertex : graph.getVertices()) {
            if (vertices.contains(vertex)) {
                ...
                while (iterator.hasNext()) {
                    vertices.remove(iterator.next());
                }
            }
            Set<Graph.Vertex> largestVertex = graph.getVertices();
            if (vertices.size() < graph.getVertices().size() - vertices.size()) {
                Iterator iterator = vertices.iterator();
                while (iterator.hasNext()) {
                    largestVertex.remove(iterator.next());
                }
